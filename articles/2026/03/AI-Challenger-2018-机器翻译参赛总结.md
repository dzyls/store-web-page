...
saved_at: "2026-03-28T15:51:59.776Z"
...
![](articles/2026/03/AI-Challenger-2018-机器翻译参赛总结/images/image_1.png)
...
![](articles/2026/03/AI-Challenger-2018-机器翻译参赛总结/images/image_3.jpg)
...
![](articles/2026/03/AI-Challenger-2018-机器翻译参赛总结/images/image_2.jpg)

![](articles/2026/03/AI-Challenger-2018-机器翻译参赛总结/images/image_7.jpg)
...
![](articles/2026/03/AI-Challenger-2018-机器翻译参赛总结/images/image_5.jpg)
...
![](articles/2026/03/AI-Challenger-2018-机器翻译参赛总结/images/image_4.jpg)

经过这样的fineune训练后，我们的模型对于测试集的数据势必有所倾向。finetune后的翻译表现也验证了我们的猜想。

![](articles/2026/03/AI-Challenger-2018-机器翻译参赛总结/images/image_6.jpg)
...
![](articles/2026/03/AI-Challenger-2018-机器翻译参赛总结/images/image_9.jpg)

我们最后选用在验证集上表现最好的参数，使用在了测试集上。

下图为最终的结果从各个模型中抽取的数量分布，从图中可以看到valid，testA，testB抽取的分布是大致一样的，这也证明了我们rerank方法是稳定且有效的。

![](articles/2026/03/AI-Challenger-2018-机器翻译参赛总结/images/image_8.jpg)
